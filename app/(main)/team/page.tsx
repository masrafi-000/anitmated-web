        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              The visionaries who started it all and continue to guide our
              mission.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {founders.map((member) => (
              <Card
                key={member.id}
                className="border-muted/60 overflow-hidden group"
              >
      ...
      <Section>
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              The talented professionals who bring our projects to life every
              day.
            </p>
          </div>
        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8 text-lg">
              ...
              growing team. If you&apos;re passionate about creating exceptional
