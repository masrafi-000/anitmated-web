        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-2xl font-bold">{counts.reviewing || 0}</div>
            )}
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-2xl font-bold">{counts.offered || 0}</div>
            )}
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-2xl font-bold">{counts.withdrawn || 0}</div>
            )}
          </CardContent>
        </Card>
        <Card>
